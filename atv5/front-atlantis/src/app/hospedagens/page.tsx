...
export default function HospedagensPage() {
  ...
  useEffect(() => {
    // Função assíncrona para buscar as hospedagens do servidor
    const fetchHospedagens = async () => {
      try {
        ...
        // Converter os valores de checkIn e checkOut para datas legíveis
        ...
        // Atualiza o estado `hospedagens` com os dados buscados
  ...
  const handleDelete = async (id: number) => {
    ...
    if (confirmed) {
      try {
        // Faça uma solicitação DELETE para excluir o hóspede com o ID especificado
